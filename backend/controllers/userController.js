...
// import jwt from "jsonwebtoken";
// import { verifyEmail } from "../emailVerify/verifyEmail.js";
// import { sendOTPMail } from "../emailVerify/sendMail.js";
...
// export const verify = async (req, res) => {
//   try {
//     // CHANGE: Check for token in Query (Email Link) OR Header (Postman)
//     // 1. req.query.token -> Comes from ?token=xyz in the URL
//     // 2. req.headers.authorization -> Comes from Bearer Token in Postman
//     const token = req.query.token || req.headers.authorization?.split(" ")[1];
...
// import bcrypt from "bcryptjs";
// import jwt from "jsonwebtoken";
// // FIX: The line below now correctly points to "verifyEmail.js" instead of "sendMail.js"
// import { verifyEmail } from "../emailVerify/verifyEmail.js";
...
// /* VERIFY (Works with BOTH Postman Header AND Email Link) */
// export const verify = async (req, res) => {
//   try {
//     // 1. Try getting token from URL (Email Link)
//     // 2. If not there, try getting it from Headers (Postman)
//     const token = req.query.token || req.headers.authorization?.split(" ")[1];
