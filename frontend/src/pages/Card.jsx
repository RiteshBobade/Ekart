    ...
    <div className='pt-20 bg-gray-50 min-h-screen'>
      {
        cart?.items?.length > 0 ?
          <div className='max-w-7xl mx-auto'>
                  ...
                  return <Card key={index}>
                    <div className='flex justify-between items-center pr-7'>
                      <div className='flex items-center w-[350px]'>
                        <img src={product?.productId?.productImg?.[0]?.url || userLogo} alt="" className='w-30 h-30' />
                      ...
                      <div className='flex gap-5 items-center'>
                        <Button onClick={() => handleUpdateQuantity(product.productId._id, 'decrease')} variant='outline' className="cursor-pointer">-</Button>
                        <span>{product.quantity}</span>
                        <Button onClick={() => handleUpdateQuantity(product.productId._id, 'increase')} variant='outline' className="cursor-pointer">+</Button>
                      </div>
            ...
            <Button onClick={() => navigate('/products')} className="mt-6 bg-pink-600 py-3 px-6 text-white  hover:bg-pink-700 cursor-pointer">Start Shopping</Button>
          </div>
      }
    </div>
  )
